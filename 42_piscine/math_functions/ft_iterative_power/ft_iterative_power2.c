...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/25 14:32:16 by anade-mo          #+#    #+#             */
/*   Updated: 2026/03/25 14:33:19 by anade-mo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Key concepts: Math, Iteration, Exponentiation
**
** Description:
** Create an iterative function that returns nb raised to the power of 'power'.
...
** Example: ft_iterative_power(2, 3) = 8
*/
//#include <stdio.h>
